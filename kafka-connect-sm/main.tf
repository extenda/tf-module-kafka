...
resource "shell_script" "connection" {
  lifecycle_commands {
    create = "python3 smkafkaconnect.py create"
    delete = "python3 smkafkaconnect.py delete"
    read   = "python3 smkafkaconnect.py read"
    update = "python3 smkafkaconnect.py update"
  }
